  ...
  describe('#changeLang()', () => {
    [
      ...
      describe(loaderMethodItem.title, () => {
        ...
        [
          {
            lang: NbTransLang.ZH_CN,
            expect: {
              changeResult: { curLang: NbTransLang.ZH_CN, result: true },
              transResult: '标题  ',
            },
          },
          {
            lang: NbTransLang.EN,
            expect: {
              changeResult: { curLang: NbTransLang.EN, result: true },
              transResult: 'title  ',
            },
          },
          {
            lang: NbTransLang.AR_EG,
            expect: {
              changeResult: { curLang: NbTransLang.ZH_CN, result: false },
              transResult: '标题  ',
            },
          },
        ].forEach(item => {
