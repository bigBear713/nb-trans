...
| options  | `INbTransOptions`  | {}  | 翻译的配置信息。具体配置见下方的[`INbTransOptions`](https://github.com/bigBear713/nb-trans/blob/master/projects/nb-trans/README.md#inbtransoptions)定义。  | `v12.0.0` |
...
| options  | `INbTransOptions`  | false  | 翻译配置。具体配置见下方的[`INbTransOptions`](https://github.com/bigBear713/nb-trans/blob/master/projects/nb-trans/README.md#inbtransoptions)定义  | `v12.0.0` |
